#!/usr/bin/env python3
"""
Ultrathink V14の簡単なテスト
改善版教師中心スケジューリングの効果を確認
"""
...
def main():
    """メイン処理"""
    logger.info("=== Ultrathink V14 Simple Test ===")
    ...
    from src.domain.services.ultrathink.ultrathink_perfect_generator_v14 import UltrathinkPerfectGeneratorV14
    ...
    try:
        ...
        repo.save_schedule(schedule, "output_v14_test.csv")
        logger.info("結果を output_v14_test.csv に保存しました")
